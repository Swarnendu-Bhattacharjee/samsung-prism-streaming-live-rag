...
async def get_scenarios():
    return [
        {
            "id": "scenario-1-multi-query",
            "title": "Compound Multi-Query (Hardware vs AI)",
            ...
            "category": "Query Decomposition & Parallel Hybrid Search",
            "description": "Tests automatic decomposition into 3 distinct sub-queries, parallel vector+BM25 search, and RRF rank fusion.",
        },
        {
            "id": "scenario-2-sharpening-p1",
            "title": "Mid-Flow Refinement — Turn 1 (Base Context)",
            ...
            "description": "Establishes base grounded context on hardware isolation and power management.",
        },
        {
            "id": "scenario-2-sharpening-p2",
            "title": "Mid-Flow Refinement — Turn 2 (In-Flow Sharpening)",
            ...
            "description": "Sharpens previous context without restarting search: retains Knox/Battery context and retrieves delta charging specs.",
        },
        {
            "id": "scenario-3-wearables",
            "title": "Wearables & Ecosystem Fusion",
            ...
            "category": "Ecosystem Multi-Domain Search",
            "description": "Searches disparate wearable knowledge bases and fuses them into a coherent grounded comparison.",
        },
        {
            "id": "scenario-4-chitchat",
            "title": "Zero-Retrieval Intent Gate",
            "prompt": "Hey! How does your streaming RAG system handle full-duplex conversational questions?",
            "category": "Intent Routing",
            "description": "Demonstrates the intent classification gate routing conversational greetings without wasting retrieval latency.",
        },
    ]
